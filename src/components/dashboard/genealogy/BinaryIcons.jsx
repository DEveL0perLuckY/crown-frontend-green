  ...
  return (
    <div className="space-y-6">
      ...
      <div className="w-full flex justify-center text-black dark:text-white">
        <div className="flex flex-wrap gap-4 p-4 rounded-xl bg-white dark:bg-gray-700/20 border border-gray-200 dark:border-gray-700   shadow  backdrop-blur-sm items-center justify-center max-w-[600px]">
