...
export default function BinaryTree({ data }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white dark:bg-gray-700/20 border border-gray-200 dark:border-gray-700  rounded-lg shadow p-4 backdrop-blur-sm">
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <input
            id="user_id"
            className="flex-1 md:w-64 p-2 rounded-md bg-white dark:bg-gray-700/20 border border-gray-200 dark:border-gray-700  shadow backdrop-blur-sm dark:text-white focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none"
            value={inputData}
            name="userId"
            type="text"
      ...
      {data?.length > 0 ? (
        <div
          className="overflow-x-auto py-5 w-full border bg-white dark:bg-gray-700/20  border-gray-200 dark:border-gray-700  rounded-lg shadow p-6 backdrop-blur-sm"
          ref={containerRef}
        >
          <div className="mx-auto max-w-[100vw] text-black dark:text-white px-[300px] lg:px-0">
