...
import Home_06 from "./pages/home/Home_06";
import NotFound from "./pages/noPage/NotFound";
import Services06 from "./pages/common/Services06";
import ServiceDetails06 from "./pages/common/ServiceDetails06";
import Team06 from "./pages/common/team/New06/Team06";
import BusinessPlan06 from "./pages/business-plan06/BusinessPlan06";
import LegalCompliance06 from "./pages/legal-compliance06/LegalCompliance06";
import SolarDoc06 from "./pages/reports/SolarDoc06";
import TradeView06 from "./pages/reports/TradeView06";
import PDFDownloads06 from "./pages/common/PDFDownloads06";
import Contact06 from "./pages/contact06/Contact06";
import Login06 from "./pages/Auth06/Login06";
import Signup06 from "./pages/Auth06/Signup06";
import ResetPassword06 from "./pages/Auth06/ResetPassword06";
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/login" element={<Login06 />} />
        <Route path="signup" element={<Signup06 />} />
        <Route path="/reset-password" element={<ResetPassword06 />} />
